...
const (
	Goods_GoodsAdd_FullMethodName  = "/goods.Goods/GoodsAdd"
...
func (c *goodsClient) GoodsAdd(ctx context.Context, in *GoodsAddRequest, opts ...grpc.CallOption) (*GoodsAddResponse, error) {
	out := new(GoodsAddResponse)
	err := c.cc.Invoke(ctx, Goods_GoodsAdd_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *goodsClient) GoodsList(ctx context.Context, in *GoodsListRequest, opts ...grpc.CallOption) (*GoodsListResponse, error) {
...
func (UnimplementedGoodsServer) GoodsAdd(context.Context, *GoodsAddRequest) (*GoodsAddResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GoodsAdd not implemented")
}
func (UnimplementedGoodsServer) GoodsList(context.Context, *GoodsListRequest) (*GoodsListResponse, error) {
...
func _Goods_GoodsAdd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsServer).GoodsAdd(ctx, req.(*GoodsAddRequest))
	}
...
func _Goods_GoodsList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsServer).GoodsList(ctx, req.(*GoodsListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
